...
[![varnish status
badge](https://carpentries.r-universe.dev/badges/varnish)](https://carpentries.r-universe.dev)

This project is part of [The Carpentries
Workbench](https://carpentries.github.io/workbench). It serves as a
template for Carpentries lessons adapted from
[{pkgdown}](https://r-lib.github.io/pkgdown). There is no need to call
this package directly, it is installed via the
...
To install this package, you can use our [R-universe
repository](https://carpentries.r-universe.dev), which is updated
hourly.
...
There is no need to call this package directly,
[{sandpaper}](https://github.com/zkamvar/sandpaper) will detect it and
...
[`source/`](https://carpentries.github.io/varnish/dev/source/) folder
with directives to include their dependencies (bootstrap, jquery,
feather).
...
- [content-chapter](https://carpentries.github.io/varnish/dev/inst/pkgdown/templates/content-chapter.md)
  displays the episodes for the lessons
- [content-syllabus](https://carpentries.github.io/varnish/dev/inst/pkgdown/templates/content-syllabus.md)
  is the landing page for the lessons
- [content-extra](https://carpentries.github.io/varnish/dev/inst/pkgdown/templates/content-extra.md)
...
- [head](https://carpentries.github.io/varnish/dev/inst/pkgdown/templates/head.md)
  contains the metadata and script loading
- [navbar](https://carpentries.github.io/varnish/dev/inst/pkgdown/templates/navbar.md)
  is a bit of misnomer, but it contains the sidebar navigation
- [header](https://carpentries.github.io/varnish/dev/inst/pkgdown/templates/header.md)
  contains metadata and favicons
- [footer](https://carpentries.github.io/varnish/dev/inst/pkgdown/templates/footer.md)
  contains navigation, credits, and JSON metadata
- [layout](https://carpentries.github.io/varnish/dev/inst/pkgdown/templates/layout.md)
...
- `{{{ resources }}}`: an additional part of the sidebar giving extra
  resource elements avaialable in mobile view.
